...
const experiences = [
  {
    ...
    points: [
      'Designed CRM systems and built 20+ n8n automation workflows covering lead capture, data syncing, notifications, and cross-platform integrations.',
      'Developed AI agents, RAG pipelines, and voice-based telephony automation with Vapi and Retell for automated inbound/outbound calling, call-flow logic, and human handoff.',
      'Owned client-facing scoping and delivery, translating business needs into scalable AI automation and CRM workflows backed by MERN and Next.js engineering.',
    ],
  },
  {
